...
bool Thread::clean = false;
char* Thread::clean_stack = NULL;
Thread* Thread::clean_thread_ptr = NULL;
...
static void thread_shutdown() {
	...
	Thread::clean = true;
	Thread::clean_stack = current_thread->get_stack_ptr();
	Thread::clean_thread_ptr = current_thread;
